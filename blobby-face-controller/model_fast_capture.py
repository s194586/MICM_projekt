"""Low-latency threaded capture for the model-based fast controller."""
...
class LatestFrameCamera:
    ...
    def start(self) -> bool:
        ...
        self._thread = threading.Thread(target=self._reader_loop, name="model-fast-camera-reader", daemon=True)
        self._thread.start()
        return True
